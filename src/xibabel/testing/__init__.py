...
from ..loaders import drop_suffixes
...
JC_EG_FUNC = (DATA_PATH / 'ds000009' / 'sub-07' / 'func' /
              'sub-07_task-balloonanalogrisktask_bold.nii.gz')
JC_EG_FUNC_JSON = drop_suffixes(JC_EG_FUNC, ('.nii.gz',)).with_suffix('.json')
JC_EG_ANAT= (DATA_PATH / 'ds000009' / 'sub-07' / 'anat' /
             'sub-07_T1w.nii.gz')
JC_EG_ANAT_JSON = drop_suffixes(JC_EG_ANAT, ('.nii.gz',)).with_suffix('.json')
